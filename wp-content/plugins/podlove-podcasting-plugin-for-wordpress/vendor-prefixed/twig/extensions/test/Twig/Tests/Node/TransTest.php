...
class Twig_Tests_Node_TransTest extends Twig_Test_NodeTestCase
{
    ...
    public function testConstructor()
    {
        ...
        $body = new Twig_Node(array(new Twig_Node_Text('Hello', 0)), array(), 0);
        $plural = new Twig_Node(array(new Twig_Node_Text('Hey ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('name', 0), 0), new Twig_Node_Text(', I have ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('count', 0), 0), new Twig_Node_Text(' apples', 0)), array(), 0);
    ...
    public function getTests()
    {
        ...
        $node = new Twig_Extensions_Node_Trans($body, null, null, null, 0);
        $tests[] = array($node, 'echo gettext("Hello");');
        $body = new Twig_Node(array(new Twig_Node_Text('J\'ai ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('foo', 0), 0), new Twig_Node_Text(' pommes', 0)), array(), 0);
        $node = new Twig_Extensions_Node_Trans($body, null, null, null, 0);
        $tests[] = array($node, \sprintf('echo strtr(gettext("J\'ai %%foo%% pommes"), array("%%foo%%" => %s, ));', $this->getVariableGetter('foo')));
        $count = new Twig_Node_Expression_Constant(12, 0);
        $body = new Twig_Node(array(new Twig_Node_Text('Hey ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('name', 0), 0), new Twig_Node_Text(', I have one apple', 0)), array(), 0);
        $plural = new Twig_Node(array(new Twig_Node_Text('Hey ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('name', 0), 0), new Twig_Node_Text(', I have ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('count', 0), 0), new Twig_Node_Text(' apples', 0)), array(), 0);
        $node = new Twig_Extensions_Node_Trans($body, $plural, $count, null, 0);
        ...
        $body = new Twig_Node(array(new Twig_Node_Text('J\'ai ', 0), new Twig_Node_Print(new Twig_Node_Expression_Filter(new Twig_Node_Expression_Name('foo', 0), new Twig_Node_Expression_Constant('escape', 0), new Twig_Node(), 0), 0), new Twig_Node_Text(' pommes', 0)), array(), 0);
        $node = new Twig_Extensions_Node_Trans($body, null, null, null, 0);
        $tests[] = array($node, \sprintf('echo strtr(gettext("J\'ai %%foo%% pommes"), array("%%foo%%" => %s, ));', $this->getVariableGetter('foo')));
        // with notes
        $body = new Twig_Node_Expression_Constant('Hello', 0);
        ...
        $plural = new Twig_Node(array(new Twig_Node_Text('There are ', 0), new Twig_Node_Print(new Twig_Node_Expression_Name('count', 0), 0), new Twig_Node_Text(' pending tasks', 0)), array(), 0);
        $notes = new Twig_Node_Text('Notes for translators', 0);
