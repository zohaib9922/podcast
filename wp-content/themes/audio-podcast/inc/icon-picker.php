...
class Audio_Podcast_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'audio-podcast' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $audio_podcast_font_awesome_icon_array = audio_podcast_font_awesome_icon_array();
                    foreach ($audio_podcast_font_awesome_icon_array as $audio_podcast_font_awesome_icon) {
                            $icon_class = $this->value() == $audio_podcast_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($audio_podcast_font_awesome_icon).'"></i>
                            <span class="audio-podcast-social-class">'.esc_attr($audio_podcast_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function audio_podcast_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'audio-podcast-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'audio_podcast_customizer_script' );

if(!function_exists('audio_podcast_font_awesome_icon_array')){
    function audio_podcast_font_awesome_icon_array(){
